...
def test_strategy(description, insample_args, outsample_args, benchmark_type, benchmark, impact, train_time, test_time, max_time, seed, grader):  		   	  			  	 		  		  		    	 		 		   		 		  
    ...
    try:  		   	  			  	 		  		  		    	 		 		   		 		  
        ...
        if not(incorrect):  		   	  			  	 		  		  		    	 		 		   		 		  
            ...
            print(in_trades_1)
            print(in_trades_2)
            print("in_trades_1 index {}".format(in_trades_1.index))
            print("in_trades_2 index {}".format(in_trades_2.index))	   	
            #print("in_trades_2 columns {}".format(in_trades_2.columns))
            #print("in_trades_1 columns {}".format(in_trades_1.columns))  			  	 		  		  		    	 		 		   		 		  
